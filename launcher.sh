...
while [ $RET -eq 0 ]; do
  GAME=$(zenity --width=350 --height=700 --list \
    --title="PyGame" \
    --text="Games by Al Sweigart. Distributed by Geruls. - Select a python game" \
    --column="Script name" --column="Information/Details" \
    ...
    tetrominoforidiots "Tetris for Idiots and dumb people" \
